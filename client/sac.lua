...
local bwtxt = "* La personne sort une arme du coffre de la voiture. *"

local dbtxt = "* La personne sort une arme du sac de sport. *"

local dbtxterr = "Je ne peux sortir cette arme que d'une voiture, ou d'un sac"

local bwtxterr = "Cette arme ne peut être retirée que d'une voiture."

local swtxt = "* La personne sort une arme. *"

local mwtxt = "* La personne sort une arme de melee. *"
		...
		if playerPed then
			...
			if daw == true then
				...
				if isWeaponBig(weapon) then
					...
					--if bagIndex == 23 or bagIndex == 22 or bagIndex == 21 or bagIndex == 40 or bagIndex == 41 or bagIndex == 44 or bagIndex == 45 or accessIndex == 11 or accessIndex == 12 or (accessIndex == 4 and GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_f_freemode_01")) then 
					...
					if GetVehiclePedIsIn(playerPed, false) == 0 and DoesEntityExist(vehicle) and IsEntityAVehicle(vehicle) and bigWeaponOut == false then
						...
						if duffle == true then
							...
							if bagIndex == 23 or bagIndex == 22 or bagIndex == 21 or bagIndex == 40 or bagIndex == 41 or bagIndex == 44 or bagIndex == 45 or accessIndex == 2 or accessIndex == 12 or (accessIndex == 4 and GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_f_freemode_01")) then 
